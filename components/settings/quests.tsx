        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] z-20 max-h-[85vh] w-[75vw] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-mauve4 p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
            <div className="grid grid-cols-5 gap-4">
              <Label.Root className="text-mauve11 w-full text-sm font-medium">Quest Name</Label.Root>
              <Label.Root className="text-mauve11 w-full text-sm font-medium">Required Item</Label.Root>
              <Label.Root className="text-mauve11 w-full text-sm font-medium">Quest Description</Label.Root>
              <Label.Root className="text-mauve11 w-full text-sm font-medium">Quest complete</Label.Root>

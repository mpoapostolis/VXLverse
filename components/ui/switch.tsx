...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        'pointer-events-none border block h-5 w-5 rounded-full bg-secondary shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-[25px] data-[state=unchecked]:translate-x-[-2px]',
      )}
    />
  </SwitchPrimitives.Root>
))
